...
#SBATCH --nodes=1
#SBATCH --mem=200G
#SBATCH --job-name=1922ER
#SBATCH --output=dotplots_phased_1922.out
#SBATCH --error=dotplots_phased_1922.err
...
######## INPUTS
reads="/projects/academic/omergokc/Luane/HG01922/herro/HG01922_10kbp_HERRO.fasta"
raw_reads="/projects/academic/omergokc/Luane/HG01922/HG01922_allreads.fastq.gz"
...
assembly_hap1="/projects/academic/omergokc/Luane/HG01922/hifiasm/diploid/HG01922.dip.hap1.p_ctg" #path to hifiasm assembly, its not the final one! - hap1 - delete the .fasta part
assembly_hap2="/projects/academic/omergokc/Luane/HG01922/hifiasm/diploid/HG01922.dip.hap2.p_ctg" #path to hifiasm assembly, its not the final one! - hap2 - delete the .fasta part

rn="hg38" #referece genome name
id="HG01922" #sample id/organism id
